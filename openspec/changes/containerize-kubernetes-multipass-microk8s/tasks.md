...
- [ ] 1.1 Review and optimize existing Dockerfile for multi-stage builds
- [ ] 1.2 Create build stage with all build dependencies (Node.js, npm)
...
- [ ] 3.3 Configure VM creation with 2 CPUs, 4GB RAM, 20GB disk
