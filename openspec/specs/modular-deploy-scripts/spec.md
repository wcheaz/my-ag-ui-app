...
Deployment scripts are modularized into independent phase-specific scripts to enable isolated testing, reduce context token consumption during ralph-loop development, and improve maintainability.
...
- **WHEN** deployment refactoring is complete
- **THEN** `deploy_scripts/` directory contains scripts for all six deployment phases
