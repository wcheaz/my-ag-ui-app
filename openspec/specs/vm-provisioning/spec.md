...
Capability for provisioning and managing multipass virtual machines to host Kubernetes clusters, including resource allocation, networking, and lifecycle management.
...
- **AND** name is descriptive (e.g., "my-ag-ui-app-k8s")
...
- **THEN** documentation explains how to scale
