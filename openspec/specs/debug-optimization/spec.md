...
Debug output is optimized for deployment scripts to reduce context token consumption during ralph-loop development while retaining debugging capability for problematic phases.
