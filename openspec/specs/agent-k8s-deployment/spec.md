...
Capability for deploying the agent service to Kubernetes using microk8s, including deployment manifests, services, health probes, and configuration management.
